...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Semantic HTML provides meaning to the web browsers so it can display correctly in proper format.
...
4. Explain why git is valuable to a team of developers. Git allows team members to save iterations of their file and provides collaboration so if users ever need to go back to an old file they can do so.

5. Define mobile-first design in your own words. Approaching the design of a website for mobile only and then you design your website for Tablet then Desktop.
